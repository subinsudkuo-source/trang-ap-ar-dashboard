...
- หน้าแรกเลือก `รพ.ตรัง` เพื่อเห็นยอดที่ต้องจ่าย ยอดที่ต้องรับ และยอดสุทธิทันที
- Dashboard เปิดงวดล่าสุดจาก Google Sheet; แบบฟอร์มรายเดือนเลือกเดือนปัจจุบันตามเวลาไทย
- หน้า รพ.ตรัง ↔ รพช. แสดงยอดที่ รพ.ตรังเป็นหนี้ แยกตามเดือนที่เกิดรายการ พร้อมตารางราย รพช.
